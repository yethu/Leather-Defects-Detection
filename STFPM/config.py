...
class Config:
    def __init__(self) -> None:
        ...
        self.parser.add_argument("--train_data_dir", type=str, default=r"C:\Users\jpmrs\OneDrive\Desktop\Dissertação\code\Data\mvtec\leather\train", help="Train directory folder path")
        ...
        self.parser.add_argument("--patience", type=float, default=10)
